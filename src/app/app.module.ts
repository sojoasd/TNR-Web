...
@NgModule({
  ...
  imports: [BrowserModule, AppRoutingModule, NgxLoadingModule.forRoot({}), HttpClientModule, FormsModule, AgmOverlays, AgmCoreModule.forRoot({ apiKey: env.mapApiKey }), ModalModule.forRoot()],
